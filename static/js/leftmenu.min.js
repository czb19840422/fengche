...
(function(){
    ...
    $('.dropdown li.selected ul').css('display', 'block');
    // var leftHeight = $(".dropdown").height(),
    //         rightHeight = $(".right-cnt").height();
    // if (leftHeight > rightHeight) {
    //     $(".right-cnt").height(leftHeight);
    //     $(".dropdown li:last-child").css("border-bottom","0");
    // } else {
    //    $(".dropdown").height(rightHeight);
    // }
})()
